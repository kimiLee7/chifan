    	...
    	<div class="col-md-10  ">
            <div class="media bg_w p10">
              ...
              <div class="media-body">
                ...
                <p><address>地址:静安区武定路1089号  <span class="tel blue">52832263</span> </address></p>
                <p><small class="label label-warning">本帮菜</small> <span class="label label-warning">清淡</span> <span class="label label-warning">干净</span> </p>
              </div>
            </div>
            <div class="media bg_w p10">
              <a href="shop-detail.html" class="pull-left">
