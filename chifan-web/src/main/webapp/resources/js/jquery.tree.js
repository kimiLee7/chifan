...
$.fn.tree = function(settings){
	...
	return $(this).each(function(){
		...
		tree.bind('expand',function(event){
				...
				target.parent().addClass('li_block');
 				target.prev('.jstree-icon').addClass('ins_block');
			...
			.bind('collapse',function(event){
				...
				target.parent().removeClass('li_block');
				target.prev('.jstree-icon').removeClass('ins_block');
		...
		tree
			.click(function(event){
                ...
                $('.menu_bar li').removeClass('current');
...
//                target.addClass('tree-item-active');
                var domainId = target.attr("domain_id"); //Bruce-conversant
                var domainName = target.attr("domain_name"); //Bruce-conversant
                var parentId=target.attr("parent_id");
                viewDomainInfo(domainId,parentId,domainName); //Bruce-conversant
